...
is the Tier-L operator gate. The contract itself lives in the harness's module docstring;
run by CI in the sim job, so "25 green" is gate-enforced, not self-reported.
