...
[acceptance harness](../../tests/acceptance_actuation.py) (23 offline checks) with proof against real
...
The offline proof is `python3 tests/acceptance_actuation.py` (23 checks). The real-push leg needs an
