...
while IFS= read -r f; do
  ...
  case "$f" in
    ...
    bin/pnl.py|bin/guard.py|bin/truth.py|bin/aiv_gate.sh|bin/conclusion_gate.py|bin/disclosure_gate.py|bin/iter.py|bin/host_check.py|bin/append_log.py|bin/verifier_loop.sh|bin/set_baseline.py|bin/sod_hook.sh|bin/edge_pnl.py|bin/edge.py|bin/bets.py) \
