...
# stdin, never string interpolation: a quote inside errors[] used to break this exact read and
# fail-SILENCE the first-dollar alert (v2 DEGRADED finding #11).
read RECV VERIF CA <<<"$(printf '%s' "$T" | python3 -c "
import json,sys
