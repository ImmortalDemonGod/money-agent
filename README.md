...
![Verification: out-of-band](https://img.shields.io/badge/verification-out--of--band-8A2BE2)
![v1: concluded, $0.00 verified](https://img.shields.io/badge/v1-concluded%20%C2%B7%20%240.00%20verified-informational)
![v2: in design](https://img.shields.io/badge/v2-in%20design-yellow)
...
| **v2** (in design) | more capital | longer, with a build-and-verify phase | The experiment v1's findings *designed*: grounded stop-verification + delayed-payoff strategies → [issues](../../issues) |
